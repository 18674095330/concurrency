...
public class SimpleHttpClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            //(SSLSocket)((SSLSocketFactory)SSLSocketFactory.getDefault()).createSocket(this.host, this.port)
            //Socket s = (SSLSocket)((SSLSocketFactory)SSLSocketFactory.getDefault()).createSocket(inetAddress, 443);
            Socket s = new Socket("www.sina.com.cn", 80);
            OutputStreamWriter osw = new OutputStreamWriter(s.getOutputStream());
            StringBuffer sb = new StringBuffer();
            sb.append("GET /HttpStream/gb2312.jsp HTTP/1.1\r\n");
            sb.append("Host: www.sina.com.cn:80\r\n");
